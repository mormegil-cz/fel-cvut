...
#define NBUFFSIZE 128		/* velikost bufferu pro cteni ze site */
...
/* pote, co prislo facknowledge s AKCR_EXISTS, bud ukoncim spojeni, nebo poslu CONF_OVER pro prepsani */
#define CONF_OVER       1

void net_receive(SOCKET s, void *buf, long int size); /* Prijme size bajtu ze socketu s do buf */
void net_send(SOCKET s, void *buf, long int size); /* Posle size bajtu z buf na socket s */
